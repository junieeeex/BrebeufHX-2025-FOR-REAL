...
photo_list_tag = [
    ['hamburgerrr.PNG', "american_restaurant"],
    ['fries.PNG', "american_restaurant"],
    ['chicken_fried.PNG', "american_restaurant"],
    ['hotdog.PNG', "american_restaurant"],
    ['beef?.PNG', "korean_restaurant"],
    ['bibimbap.PNG', "korean_restaurant"],
    ['koreanfriedchicken.PNG', "korean_restaurant"],
    ['kimbap.PNG', "korean_restaurant"],
    ['armysoup.PNG', "korean_restaurant"],
    ['matchawaffles.PNG', "cafe"],
    ['cupcakes.PNG', "cafe"],
    ['carrotcake.PNG', "cafe"],
    ['icecoffee.PNG', "cafe"],
    ['matchalatte.PNG', "cafe"],
    ['mangostickyrice.PNG', "thai_restaurant"],
    ['shrimp.PNG', "thai_restaurant"],
    ['gingerthing.PNG', "thai_restaurant"],
    ['eggchicken.PNG', "thai_restaurant"],
    ['bols.PNG', "thai_restaurant"],
    ['padthai.PNG', "thai_restaurant"],
    ['redcurry.PNG', "indian_restaurant"],
    ['pate.PNG', "indian_restaurant"],
    ['mix.PNG', "indian_restaurant"],
    ['samosa.PNG', "indian_restaurant"],
    ['ballz.PNG', "indian_restaurant"],
    ['burrito.PNG',"mexican_restaurant"],
    ['nachos.PNG', "mexican_restaurant"],
    ['tacos.PNG', "mexican_restaurant"],
    ['softtaco.PNG', "mexican_restaurant"],
    ['guac.PNG', "mexican_restaurant"],
    ['hotpot.PNG', "chinese_restaurant"],
    ['weirdbol.PNG', "chinese_restaurant"],
    ['dimsum.PNG', "chinese_restaurant"],
    ['dumplings.PNG', "chinese_restaurant"],
    ['sushi.PNG', "japanese_restaurant"],
    ['tempura.PNG', "japanese_restaurant"],
    ['onigiri.PNG', "japanese_restaurant"],
    ['okonomyaki.PNG', "japanese_restaurant"],
    ['ramen.PNG', "japanese_restaurant"],
    ['pizza.PNG', "italian_restaurant"],
    ['pasta.PNG', "italian_restaurant"],
    ['gelato.PNG', "italian_restaurant"],
    ['risotto.PNG', "italian_restaurant"],
    ['chocolate.PNG', "italian_restaurant"]
]
